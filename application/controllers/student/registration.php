...
class Registration extends CI_Controller {
        ...
        function index()
        {
        	...
        	if($log == true){
        		...
        		$this->load->view('student/registration/body');
        		$this->load->view('student/general/script');
        		$this->load->view('student/registration/script');
        ...
        function search(){
        	$data = $this->m_mahasiswa->getMhs($this->session->userdata('student_detail')['NIM']);
//         	print_r($data);exit;
        	$html = '';
